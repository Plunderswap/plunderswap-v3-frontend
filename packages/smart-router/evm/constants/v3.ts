...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA_TESTNET]: '0xC4269c5D13185a619b10177F18FD9755824b2b7D',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA_TESTNET]: '0x748Ab39383f24fab62A440014C2B977bB744d424',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.ZILLIQA_TESTNET]: '0x112Ed339F5472212E19051322717092d216Dc36e',
} as const satisfies Record<ChainId, Address>
