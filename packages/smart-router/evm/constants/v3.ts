...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA_TESTNET]: '0x3AEAaE640C63acD101474DD52b851cdF924EAe83',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA_TESTNET]: '0xedE988e27525160ccd04bA1802786884c19C131F',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.ZILLIQA_TESTNET]: '0x5c92804ecC9D65C7A65Fedbb61f9E3d033FEde0D',
} as const satisfies Record<ChainId, Address>
