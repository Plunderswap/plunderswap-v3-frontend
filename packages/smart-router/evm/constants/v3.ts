...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA]: '0xC4269c5D13185a619b10177F18FD9755824b2b7D',
  [ChainId.ZILLIQA_TESTNET]: '0x3C4D95B0fB3cCB56199C06877A2b0D246628AB3d',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA]: '0x748Ab39383f24fab62A440014C2B977bB744d424',
  [ChainId.ZILLIQA_TESTNET]: '0x553537096e53B7398E57aBad69B258ebF6d161E4',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.ZILLIQA]: '0x112Ed339F5472212E19051322717092d216Dc36e',
  [ChainId.ZILLIQA_TESTNET]: '0xc520F773c9D507bB7bDf3d5fC106231C4D11C232',
} as const satisfies Record<ChainId, Address>
