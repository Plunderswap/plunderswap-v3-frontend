...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA]: '0x32157371f4378Cf900e27B497a8D0990d70947f2',
  [ChainId.ZILLIQA_TESTNET]: '0x69B821d0d612bB93953414751b828710Fe6f02C2',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA]: '0x83881504b993c513cA2a3c94BE84CDdB53044eaC',
  [ChainId.ZILLIQA_TESTNET]: '0x81B756F7aa490cFDcE3A2AcFA91cD2E5Ed67471e',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.ZILLIQA]: '0xcA8eA52202cC6eD00a366040da475421EbE3A904',
  [ChainId.ZILLIQA_TESTNET]: '0xB3157e38e8A32ED63595Afcb90CB8AC29bEFfe31',
} as const satisfies Record<ChainId, Address>
