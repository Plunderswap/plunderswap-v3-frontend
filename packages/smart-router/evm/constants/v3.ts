...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA_TESTNET]: '0x70D9C9dBc7d1578C7a24B6CAc183E9BEE2E03Ffd',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.ZILLIQA_TESTNET]: '0x777d8555bE8376d16C8d91154be65A5AEc4EB6A3',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.ZILLIQA_TESTNET]: '0x3E20994C150553e9af9a3973d95602B3daFC7088',
} as const satisfies Record<ChainId, Address>
