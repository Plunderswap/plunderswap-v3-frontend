...
export const lightColors = {
  ...
  textSubtle: "#7A6EAA",
  disabled: "#E9EAEB",
  gradientPrimary: "linear-gradient(228.54deg, #1FC7D4 -13.69%, #4153A4 91.33%)",
  ...
  gradientBold: "linear-gradient(#53DEE9, #4153A4)",
};
...
export const darkColors = {
  ...
  textSubtle: "#B8ADD2",
  disabled: "#524B63",
  gradientPrimary: "linear-gradient(228.54deg, #1FC7D4 -13.69%, #879BF6 91.33%)",
  ...
  gradientGold: "linear-gradient(180deg, #FFD800 0%, #FDAB32 100%)",
  gradientBold: "linear-gradient(#53DEE9, #879BF6)",
};
