...
const ZILLIQA_TESTNET = 'https://plunderswap.github.io/token-lists/zq2-proto-testnet.json'
const ZILLIQA = 'https://plunderswap.github.io/token-lists/zq2-proto-mainnet.json'
